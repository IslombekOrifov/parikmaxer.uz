    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_id', models.CharField(db_index=True, error_messages={'unique': 'A user with that custom_id already exists.'}, max_length=12, unique=True)),
                ('image', models.ImageField(blank=True, null=True, upload_to=accounts.services.upload_avatar_path, validators=[accounts.validators.validate_image])),
                ('gender', models.CharField(choices=[('', 'None'), ('ma', 'Male'), ('fe', 'Female')], default='', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=accounts.services.upload_news_path, validators=[accounts.validators.validate_image])),
